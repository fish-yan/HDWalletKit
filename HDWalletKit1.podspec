Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/fish-yan/HDWalletKit.git'
  s.license          = { :type => 'MIT', :file => 'LICENSE.md' }
  s.author           = { 'impl' => 'pavlo.bojkoo@gmail.com' }
  s.source           = { :git => 'https://github.com/fish-yan/HDWalletKit.git', :tag => s.version.to_s }
  ...
  s.source_files = 'Sources/HDWalletKit/**/*.{swift}'
